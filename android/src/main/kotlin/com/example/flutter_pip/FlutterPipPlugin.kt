package com.example.flutter_pip
...
const val CHANNEL: String = "flutter_pip"

/** FlutterPipPlugin */
public class FlutterPipPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    companion object {
        ...
        fun registerWith(registrar: Registrar) {
            FlutterPipPlugin().onAttachedToEngine(registrar.context(), registrar.messenger())
        }
    }
